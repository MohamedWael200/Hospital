    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="contact-box">
                ...
                <form method="POST" action="{{route('SaveSurgery')}}" enctype="multipart/form-data">
                    @csrf
                <div class="right">
                    <h2>Add Surgery</h2>
                    <input type="text" class="field" placeholder="Surgery Name" name="OperationName">
                    <textarea placeholder="Surgery description" class="field" name="OperationDes"></textarea>
                    <input type="text" class="field" placeholder="Surgery Cost" name="OperationCost">

                    <label for="cars" class="labSelect">Doctors :</label>
                    <select name="doctors_id" id="category" class="field">
