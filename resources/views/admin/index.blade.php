    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="cardBox">
                <div class="card">
                    <div>
                        <div class="numbers">{{$programCount}}</div>
                        <div class="cardName">$program Count</div>
                    </div>
                ...
                <div class="card">
                    <div>
                        <div class="numbers">{{$Doctorcount}}</div>
                        <div class="cardName">Doctor Count</div>
                    </div>
                ...
                <div class="card">
                    <div>
                        <div class="numbers">{{$ClincCount}}</div>
                        <div class="cardName">Clinc Count</div>
                    </div>
                ...
                <div class="card">
                    <div>
                        <div class="numbers">{{$paientCount}}</div>
                        <div class="cardName">Paient Count</div>
                    </div>
